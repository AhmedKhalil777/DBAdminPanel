...
See the [sample application](src/DBAdminPanel.Sample) for a complete working example with:
...
Then navigate to `https://localhost:XXXX/DBAdminPanel` (port shown in Aspire dashboard).
...
DBAdminPanel/
├── src/
│   ├── DBAdminPanel/              # Main package
│   │   ├── dbadminpanel-ui/       # Angular frontend
│   │   └── wwwroot/               # Static files (generated)
│   ├── DBAdminPanel.SourceGenerator/  # Source generator
│   ├── DBAdminPanel.Sample/       # Sample application
│   └── DBAdminPanel.AppHost/      # Aspire host
└── .github/
    └── workflows/
...
- [Sample Application README](src/DBAdminPanel.Sample/README.md)
- [API Documentation](docs/API.md) (coming soon)
- [Advanced Configuration](docs/Configuration.md) (coming soon)

## 🐛 Known Issues

- Entity names with special characters may need manual route configuration
- Very large datasets (>10,000 records) may require custom pagination
- Complex inheritance hierarchies may need additional configuration

## 🔮 Roadmap

- [ ] Authentication and authorization support
- [ ] Custom field types and editors
- [ ] Bulk operations
...
- **Generated Controllers**: Automatic per entity
- **Supported Databases**: All EF Core supported databases
- **Entity Types**: All EF Core supported entity types
...
<div align="center">
  ...
  [⭐ Star us on GitHub](https://github.com/ahmedkhalil777/DBAdminPanel) | [📦 NuGet Package](https://www.nuget.org/packages/DBAdminPanel) | [📖 Documentation](README.md)
</div>
